      ...
      <div class="col-md-12">
          ...
          <div class="col-md-2">
              ...
              <div class="col-md-6 offset-md-1">
                  <h1><?= $movie->title ?></h1>
                  <p class="page-description">Altere os dados do filmeno formulário abaixo:</p>
                  ...
                  <input type="hidden" name="id" value="<?= $movie->id ?>" >
                   ...
                   <option value="Comédia" <?= $movie->category === "Comédia" ?"selected" : "" ?>>Comédia</option>
                     ...
                     <option value="Drama" <?= $movie->category === "ação" ?"selected" : "" ?>>Drama</option>

                   <option value="Fantasia" <?= $movie->category === "ação" ?"selected" : "" ?>>Fantasia</option>
                  ...
                  <textarea name="description" id="description" cols="" rows="5" class="form-control" placeholder="Descreva o filme"><?= $movie->description ?></textarea> 
                 </div>
